...
print(f" ***** array job {array_number} for size=({input_L}), V={input_V}, p={input_p}, B={input_B}, T={time_steps} and X={input_X} ***** ")
print("")
...
if __name__ == '__main__':
    ...
    if ploting: ################################################# PLOTING ########################################################
        ...
        fig.savefig(plot_path + f"plot_L{input_L:01}_P{input_p:.2f}_V{input_V:.1f}_B{input_B:.3f}_T{time_steps_exp}_X{input_X}_N{num_traj_exp}_A{array_number:03}_J{job_number}.png", dpi=300, bbox_inches = 'tight')    
    ...
    if saving: ######################## SAVING ##################################
        ...
        arcivo = open(save_path + f'data_L{input_L:01}_V{input_V:.1f}_B{input_B:.3f}_P{input_p:.2f}_T{time_steps_exp}_X{input_X}_N{num_traj_exp}_A{array_number:03}.npy', 'wb')  
